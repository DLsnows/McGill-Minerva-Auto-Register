...
const en = {
  ...
  settings: {
    ...
    keepAwake: 'Keep this PC awake while AutoRegister runs', keepAwakeAria: 'Keep this PC awake',
    keepAwakeNoSleep: 'No auto-sleep: the PC will not go to sleep while the switch is on.',
    keepAwakeDisplayNote: 'The display still turns off normally — blocking sleep is not the same as blocking the screen from switching off.',
    keepAwakeLaptopNote: 'Laptop: this only applies while the charger is connected. On battery the PC still sleeps as usual, to protect your battery.',
    keepAwakeDesktopNote: 'Desktop: it stays awake the whole time the switch is on.',
    keepAwakeExitNote: 'Turn the switch off or quit AutoRegister and normal power behaviour resumes immediately.',
...
const zh: typeof en = {
  ...
  settings: {
    ...
    keepAwake: '运行期间不让这台电脑自动休眠', keepAwakeAria: '保持电脑不休眠',
...
const fr: typeof en = {
  ...
  settings: {
    ...
    keepAwake: 'Garder ce PC éveillé pendant l’exécution d’AutoRegister', keepAwakeAria: 'Garder ce PC éveillé',
    keepAwakeNoSleep: 'Pas de veille automatique : le PC ne se met pas en veille tant que l’option est activée.',
    keepAwakeDisplayNote: 'L’écran s’éteint toujours normalement — empêcher la veille n’empêche pas l’extinction de l’écran.',
    keepAwakeLaptopNote: 'Portable : ne s’applique que sur secteur. Sur batterie, le PC se met en veille comme d’habitude, pour préserver la batterie.',
    keepAwakeDesktopNote: 'Ordinateur de bureau : reste éveillé tant que l’option est activée.',
    keepAwakeExitNote: 'Désactivez l’option ou quittez AutoRegister : le comportement d’alimentation normal reprend immédiatement.',
